...
""")
    st.markdown("[Open Auction Run Report on CATS](https://cats.capitalautoauction.com/reports/customized/vehicles-summary?selected_report=&date_type=auctionAt&date_from=08%2F22%2F2026&date_to=08%2F22%2F2026&yard=&auctionType=&lane=&no_title=&isReleased=&stock_number_from=&stock_number_to=&arbitration=2&driver_assigned=&qb_check_printed=&charity_paid=&green_light=&title_status=&report_group=&quote_status=&pp_bid_id=&auto_offer_type_id=&priority_lead=&priority_second_lead=&has_tasks=&innovative_claims=&peddle=&bidderSearchType=phone&bidderQuery=&is_avg_wear=&showPicture=0&showDocuments=0&removeCancelled=0&removeTitleChecked=0&removeSold=0&excludeDirectBuy=0&report_title=&available_fields%5B%5D=85&available_fields%5B%5D=63&available_fields%5B%5D=783&available_fields%5B%5D=144&selected_fields%5B%5D=1&selected_fields%5B%5D=34&selected_fields%5B%5D=124&selected_fields%5B%5D=63&report_name=&report_format=web&report_range=&report_featured=0&report_id=)")
